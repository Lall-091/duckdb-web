...
In this blog post, we highlight a few important fixes in DuckDB v1.5.5, the sixth patch release in [DuckDB's 1.5 (Variegata) line]({% post_url 2025-09-16-announcing-duckdb-140 %}).
