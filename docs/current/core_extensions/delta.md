...
> Warning We are aware of a regression in Azure Onelake which appears to be a consequence of a change in `delta-kernel-rs`. You can track the issue [here](https://github.com/duckdb/duckdb-delta/issues/307).
